        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            <div className="space-y-4">
              <span className="text-caps-s text-pink">{settings?.founderRole || 'Built by a Hotel General Manager'}</span>
              <h2 className="text-[2.5rem] md:text-h3 leading-tight">
                {settings?.founderName ? `Practical tools from ${settings.founderName}'s experience` : 'Practical tools from real experience'}
              </h2>
            </div>
          ...
          >
            <img 
              src={settings?.founderImage || "https://picsum.photos/seed/founder/800/800"} 
              alt={settings?.founderName || "Hotel General Manager"} 
